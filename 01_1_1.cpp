/*
Compile: g++ 01.cpp -o 01_1_1.exe -I"C:\OpenCL-SDK\include" -lOpenCL
EUN: Use the flags only when needed:
.\01_1_1.exe -h shows the help message
.\01_1_1.exe -l lists all available OpenCL platforms and devices
.\01_1_1.exe -p 0 -d 1 runs on platform 0, device 1
*/
#include <iostream>
#include <vector>
